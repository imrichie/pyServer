...
menuItem1 = MenuItem(name='French Fries', description='With garlic and cheese', price='$2.99', course='Appetizer', restaurant=restaurant1)
# session.add(menuItem1)
# session.commit()

menuItem2 = MenuItem(name='Veggie Burger', description='Juicy grilled veggie', price='$7.50', restaurant=restaurant1)
